...
INSERT INTO Productos (Nombre, Descripcion, Precio, Stock, IDCategoria, IDProveedor, IDMarca)
VALUES
('Martillo Uña', 'Martillo de acero', 4500, 20, 1, 1, 1),
('Pinza Universal', 'Pinza 8 pulgadas', 3500, 15, 1, 1, 1),
('Taladro Bosch', 'Taladro percutor 600W', 55000, 10, 2, 2, 2),
('Pintura Blanca 4L', 'Pintura látex interior', 12000, 12, 3, 3, 8),
('Cemento x 25kg', 'Bolsa cemento Avellaneda', 3800, 50, 4, 4, 7),
('Llave Termomagnética', 'Llave 20A', 2500, 30, 2, 5, 8),
('Cinta Métrica 5m', 'Truper profesional', 2700, 25, 8, 6, 5),
('Amoladora 850W', 'Amoladora Makita', 65000, 8, 2, 7, 6);
